...
class CurrentWeatherAdapter(private val mContext: Context, private val mWeatherList: List<Weather>) : RecyclerView.Adapter<CurrentWeatherAdapter.CurrentWeatherViewHolder>() {
